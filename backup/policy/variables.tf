...
variable "section_id" {
  description = "To which compliance framework section does this rule belong to"
  type        = string
}

variable "requirement_id" {
  description = "To which compliance framework requirement does this rule belong to"
  type        = string
}

variable "compliance_id" {
  description = "To which compliance framework does this rule belong to"
  type        = string
}
*/
